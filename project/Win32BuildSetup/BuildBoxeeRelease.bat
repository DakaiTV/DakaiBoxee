...
:COMPILE_EXE
  ...
  rem %NET% %CLEAN_EXE%
  rem ECHO Updating SVN revision...
  rem SubWCRev ..\..\ ..\..\guilib\system.h ..\..\guilib\system.h
...
:MAKE_BUILD_EXE
  ...
  move BUILD_WIN32\Boxee\visualisations\goom_win32.vis BUILD_WIN32\Boxee\visualisations\goom.vis 
  move BUILD_WIN32\Boxee\visualisations\ProjectM_win32.vis BUILD_WIN32\Boxee\visualisations\ProjectM.vis 
  ...
  xcopy ..\..\media BUILD_WIN32\Boxee\media\*.xpr /E /Q /I /Y /EXCLUDE:exclude.txt  > NUL
